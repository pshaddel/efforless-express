module.exports = (req, res, next) => {
    ...
    const address = process.env.baseURL ? process.env.baseURL  + req.originalUrl :  module.parent.path + "/src" + req.originalUrl;
    try {
        ...
        try{
            ...
            res.status(404).send("simple-express couldn't find your file")
        }
    }
    next();
}